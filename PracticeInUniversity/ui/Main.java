...
public void showMenu(){
	 ...
	 Employeer emp1 = new Employeer("Armando", "1005976323","12/03/2018", new ServiceType("Pedicure", 12, 12000, 30000), new ServiceType(null,null,null,null), new ServiceType(null,null,null,null));
	 Employeer emp2 = new Employeer("Diego", "1005679848", "19/06/2001", new ServiceType(null,null,null,null), new ServiceType("Cabello",14, 30000, 50000), new ServiceType(null,null,null,null));
			 ...
			 if(numbEmple == 1){
				 ...
				 if(numbS == 1){
					 ...
					 empleados.setService1(pedicure);
						 ...
						 System.out.println("No existe o no se puede mi fai" + "Su numero de veces al servicio es " + empleados.getService1().setNumberTime(numeroDeVecesDelServicioP+ getNumberTime()));
					 }
				 }else if( numbS == 2){
					 ...
					 empleados.setService2(cabello);
						 ...
						 System.out.println("No existe o no se puede mi fai" + "Su numero de veces al servicio es " + empleados.getService2().setNumberTime(numeroDeVecesDelServicioH + getNumberTime()));
					 }
				 }else if( numbS == 3){
					 ...
					 System.out.println("No existe o no se puede mi fai" + "Su numero de veces al servicio es " + empleados.getService3().setNumberTime(numeroDeVecesDelServicioM + getNumberTime()));
				 }
			 }else if(numbEmple == 2){
				 ...
				 if(numbR == 1){
					 ...
					 System.out.println(empleados.setService1(pedicure));
						 ...
						 System.out.println("No existe o no se puede mi fai" + "Su numero de veces al servicio es " + empleados.getService1().setNumberTime(numeroDeVecesDelServicioP2 + getNumberTime());
					 }
				 }else if( numbR == 2){
					 ...
					 empleados.setService2(pedicure);
						 ...
						 System.out.println("No existe o no se puede mi fai" + "Su numero de veces al servicio es " + empleados.getService2().setNumberTime(numeroDeVecesDelServicioH2 + getNumberTime());
					 }
				 }else if( numbR == 3){
					 ...
					 empleados.setService1(pedicure);
						...
						System.out.println("No existe o no se puede mi fai" + "Su numero de veces al servicio es " + empleados.getService3().setNumberTime(numeroDeVecesDelServicioM2 + getNumberTime());
					 }
				 }else {
