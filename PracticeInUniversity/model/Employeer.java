...
public String showInfoClient(){
	...
	msj += "El empleado" + getNameEmployer() + "de identificación" + getIdentify() + "Su fecha de ingreso" + getDateIn() + "Los servicios que presta son 1" + "1."+ service1.showInfoServiceType() + "2." + service2.showInfoServiceType() + "3." + service3.showInfoServiceType();
	msj += "El empleado" + getNameEmployer() + "de identificación" + getIdentify() + "Su fecha de ingreso" + getDateIn() + "Los servicios que presta son 1" + "1."+ service1.showInfoServiceType() + "2." + service2.showInfoServiceType() + "3." + service3.showInfoServiceType();
	return msj;
}
